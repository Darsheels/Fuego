...
class Player(pygame.sprite.Sprite):
    def __init__(self,x,y):
       ...
       self.walk_frames = load_sprite_sheet("assets/images/player/DefaultPlayer.png" , 32 , 32)
       self.idle_frames = load_sprite_sheet("assets/images/player/idleFireFighter.png" , 32 , 32)
